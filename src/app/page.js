...
export default function HomePage() {
  ...
  const firstThreeServices = data.serviceinfo && data.serviceinfo.slice(0, 3);
  ...
  // Get the rest of the items
  const remainingProjects = data.projectinfo && data.projectinfo.slice(3, 6);
  ...
  return (
    <>
      ...
      <section className="black-bg pt-60 pb-40">
        <AnimatedImage
          imageUrl={"images/left-image.png"}
        ...
        <AnimatedImage
          imageUrl={"images/right-image.png"}
          extraclass="animate-image-right visible"
        />
      </section>

      {/* <!-- Video Section --> */}
      <section className="black-bg pt-0 pb-0" data-aos="zoom-in-down">
