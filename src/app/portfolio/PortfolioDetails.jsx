    ...
    <>
      {data?.code === 200 && (
        <>
              ...
              <div className="row justify-content-center">
                <div className="col-lg-12 col-md-12">
                  <div className="content text-uppercase">
                    ...
                    {data?.post?.title && (
                      <h1 className="py-3 text-white text-left pe-5">
                        {data.post.title}
                      </h1>
                    )}
                  </div>
          ...
          <section className="black-bg pt-20 pb-40 project-details">
            ...
            <div className="container">
              <div className="row justify-content-center pt-40 pb-40">
                {data?.post?.content && (
                  <div
                    className="col-lg-10 col-md-10 text-center text-lite pt-60 fon-size-22"
